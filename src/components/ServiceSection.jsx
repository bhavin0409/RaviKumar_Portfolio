        ...
        <section className='w-full md:p-10 px-5 md:px-28 '>
            <div className='grid grid-cols-1 md:grid-cols-2 pt-14'>
                <div className='flex items-start justify-start flex-col px-5 py-7 border border-b-slate-500'>
                    ...
                    <br />
                    <p className='text-gray-500'>I speak directly with clients to gather their requirements and then connect with my network to find suitable matches. Based on the requirements, I identify the right clients and bring together both sellers and buyers to help finalize the deal.
                    </p>
                </div>
                <div className='flex items-start justify-start flex-col px-5 py-7 border border-b-slate-500'>
                    <div>
                    ...
                    <br />
                    <p className='text-gray-500'>We fulfill client requirements for application development as well as website design and development.
                    </p>
                </div>
                <div className='flex items-start justify-start flex-col px-5 py-7 border border-b-slate-500'>
                    <div>
                ...
                <div className='flex items-start justify-start flex-col px-5 py-7 border border-b-slate-500'>
                    ...
                    <br />
                    <p className='text-gray-500'>I am always interested in exploring new business opportunities and building new relationships and networks.</p>
                </div>
            </div>
        </section>
    )
