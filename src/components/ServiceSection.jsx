    ...
    return (
        <section className='w-full md:p-10 px-5 md:px-28 '>
            <div className='grid grid-cols-1 md:grid-cols-2 pt-14'>
                <div className='flex items-start justify-center flex-col px-5 py-7 border border-b-slate-500'>
                    <PencilRuler className='font-bold text-[#00487F] text-2xl mt-1' />
                    <br />
                ...
                <div className='flex items-start justify-center flex-col px-5 py-7 border border-b-slate-500'>
                    <LaptopMinimalCheck className='font-bold text-[#00487F] text-2xl mt-1' />
                    <br />
                    <p>We fulfill client requirements for application development as well as website design and development.
                    </p>
                </div>
                <div className='flex items-start justify-center flex-col px-5 py-7 border border-b-slate-500'>
                    <ConstructionIcon className='font-bold text-[#00487F] text-2xl mt-1' />
                    <br />
                ...
                <div className='flex items-start justify-center flex-col px-5 py-7 border border-b-slate-500'>
                    <MoreHorizontal className='font-bold text-[#00487F] text-2xl mt-1' />
                    <br />
